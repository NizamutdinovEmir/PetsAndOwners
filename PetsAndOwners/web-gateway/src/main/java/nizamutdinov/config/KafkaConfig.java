...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, OwnerDTO> ownerConsumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "web-gateway-owner");
    ...
    @Bean
    public ConsumerFactory<String, PetDTO> petConsumerFactory() {
        ...
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "web-gateway-pet");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PetDTO> petKafkaListenerContainerFactory() {
